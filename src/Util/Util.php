...
class Util {
	...
	public static function encodeString( $string ) {
		...
		$map[$string] = $string;
		$replacements = [
			'[αάàáãâǎȃăäāå]'  => 'a',  '[ΑΆÀÁÃÂǍȂĂÄĀÅ]' => 'A',
			'[æ]'             => 'ae', '[Æ]'            => 'AE',
			'[β]'             => 'b',  '[Β]'            => 'B',
			'[çč]'            => 'c',  '[ÇČ]'           => 'C',
			'[χ]'             => 'ch', '[Χ]'            => 'CH',
			'[δđ]'            => 'd',  '[ΔĐ]'           => 'D',
			'[εéèẽêěȇĕëē]'    => 'e',  '[ΕÉÈẼÊĚȆĔËĒ]'   => 'E',
			'[η]'             => 'eh', '[Η]'            => 'EH',
			'[φϕ]'            => 'f',  '[Φ]'            => 'F',
			'[γ]'             => 'g',  '[Γ]'            => 'G',
			'[θħ]'            => 'h',  '[ΘĦ]'           => 'H',
			'[ιíìĩîǐȋĭïī]'    => 'i',  '[ΙÍÌĨÎǏȊĬÏĪ]'   => 'I',
			'[κ]'             => 'k',  '[Κ]'            => 'K',
			'[λł]'            => 'l',  '[ΛŁ]'           => 'L',
			'[μ]'             => 'm',  '[Μ]'            => 'M',
			'[νñ]'            => 'n',  '[ΝÑ]'           => 'N',
			'[ŋ]'             => 'ng', '[Ŋ]'            => 'NG',
			'[οóòõôǒȏŏöōø]'   => 'o',  '[ΟÓÒÕÔǑȎŎÖŌØ]'  => 'O',
			'[œ]'             => 'oe', '[Œ]'            => 'OE',
			'[ω]'             => 'oh', '[Ω]'            => 'OH',
			'[π]'             => 'p',  '[Π]'            => 'P',
			'[ψ]'             => 'ps', '[Ψ]'            => 'PS',
			...
			'[τŧ]'            => 't',  '[ΤŦ]'           => 'T',
			'[þ]'             => 'th', '[Þ]'            => 'TH',
			'[υúùũûǔȗŭüūů]'   => 'u',  '[ΥÚÙŨÛǓȖŬÜŪŮ]'  => 'U',
			'[ẃẁŵẅẘ]'         => 'w',  '[ẂẀŴẄW̊]'        => 'W',
			'[ξ]'             => 'x',  '[Ξ]'            => 'X',
			'[ýỳỹŷÿȳẙ]'       => 'y',  '[ÝỲỸŶŸȲY̊]'      => 'Y',
			'[ζž]'            => 'z',  '[ΖŽ]'           => 'Z',
			'[^a-zA-Z0-9_. ]' => '_'
		];
