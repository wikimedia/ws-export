...
class ExportController extends AbstractController {
	...
	private function export(
		...
		// Fetch the first page to check that it exists. If it does, it'll be cached and this won't be done again.
		...
		$bus->dispatch( new CreateBookMessage( $book, $filePath, $format, time() + 30 ) );
