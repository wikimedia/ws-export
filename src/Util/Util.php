...
class Util {
	...
	public static function encodeString( $string ) {
		...
		$map[$string] = $string;
		$replacements = [
			'[αάаàáãâǎȃăäāå]' => 'a',  '[ΑΆАÀÁÃÂǍȂĂÄĀÅ]' => 'A',
			'[æ]'             => 'ae', '[Æ]'             => 'AE',
			'[βб]'            => 'b',  '[ΒБ]'            => 'B',
			'[çč]'            => 'c',  '[ÇČ]'            => 'C',
			'[χ]'             => 'ch', '[Χ]'             => 'CH',
			'[χ]'             => 'ch', '[Χ]'             => 'CH',
			'[δдđ]'           => 'd',  '[ΔДĐ]'           => 'D',
			'[εэеéèẽêěȇĕëē]'  => 'e',  '[ΕЭЕÉÈẼÊĚȆĔËĒ]'  => 'E',
			'[η]'             => 'eh', '[Η]'             => 'EH',
			'[φϕф]'           => 'f',  '[ΦФ]'            => 'F',
			'[γг]'            => 'g',  '[ΓГ]'            => 'G',
			'[θхħ]'           => 'h',  '[ΘХĦ]'           => 'H',
			'[ιиíìĩîǐȋĭïī]'   => 'i',  '[ΙИÍÌĨÎǏȊĬÏĪ]'   => 'I',
			'[κк]'            => 'k',  '[ΚК]'            => 'K',
			'[λлł]'           => 'l',  '[ΛЛŁ]'           => 'L',
			'[μм]'            => 'm',  '[ΜМ]'            => 'M',
			'[νнñ]'           => 'n',  '[ΝНÑ]'           => 'N',
			'[ŋ]'             => 'ng', '[Ŋ]'             => 'NG',
			'[οоóòõôǒȏŏöōø]'  => 'o',  '[ΟОÓÒÕÔǑȎŎÖŌØ]'  => 'O',
			'[œ]'             => 'oe', '[Œ]'             => 'OE',
			'[ω]'             => 'oh', '[Ω]'             => 'OH',
			'[πп]'            => 'p',  '[ΠП]'            => 'P',
			'[ψ]'             => 'ps', '[Ψ]'             => 'PS',
			...
			'[þ]'             => 'th', '[Þ]'             => 'TH',
			'[ц]'             => 'ts', '[Ц]'             => 'TS',
			'[υуúùũûǔȗŭüūů]'  => 'u',  '[ΥУÚÙŨÛǓȖŬÜŪŮ]'  => 'U',
			'[в]'             => 'v',  '[В]'             => 'V',
			'[ẃẁŵẅẘ]'         => 'w',  '[ẂẀŴẄW̊]'         => 'W',
			'[ξ]'             => 'x',  '[Ξ]'             => 'X',
			'[ыьйýỳỹŷÿȳẙ]'    => 'y',  '[ЫЬЙÝỲỸŶŸȲY̊]'    => 'Y',
			'[я]'             => 'ya', '[Я]'             => 'YA',
			'[ё]'             => 'yo', '[Ё]'             => 'YO',
			'[ю]'             => 'yu', '[Ю]'             => 'YU',
			'[ζзž]'           => 'z',  '[ΖЗŽ]'           => 'Z',
		...
		foreach ( $replacements as $search => $replace ) {
			$map[$string] = mb_ereg_replace( $search, $replace, $map[$string] );
		}
